...
FraudToRules finds logical rules with high precision and fuse them. Finding good
rules is done by fitting classification or regression trees to sub-samples.
...
This example aims at finding logical rules to predict credit defaults. The analysis shows that 
setting.
...
###############################################################################
# Getting rules with a Decision Tree and Random Forests
# ..................
#
# This part shows the training and performance evaluation of two tree-based models.
# The objective remains to extract rules which targets credit defaults. 
# This benchmark shows the performance reached with a decision tree and a random forest.
...
RF = GridSearchCV(RandomForestClassifier(n_estimators = 30, class_weight = 'balanced'),
                  param_grid={
...
###############################################################################
# The ROC and Precision-Recall curves show that both models approximatively have the same performances for low True Positive Rates (also called Recall).
# This "low-recall" domain is visible around the bottom right hand side of the ROC curve and on the left side of the Precision-Recall curve.
# A good performance on this part of the curve means that the model can precisely detect a fraction of credit defaults (the easiest one).
# For highest recalls, Random Forests shows a better performance in this domain.




###############################################################################
# Getting rules with ftrules
# ..................
#
